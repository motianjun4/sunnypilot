...
def create_accel_command(packer, accel, pcm_cancel, standstill_req, lead, acc_type, gap_tr_line, reverse_acc_change, lead_standstill):
  ...
  values = {
    ...
    "LEAD_STANDSTILL": lead_standstill,
  }
  return packer.make_can_msg("ACC_CONTROL_SAFE", 0, values)
